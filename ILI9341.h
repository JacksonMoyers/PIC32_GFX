...
#define TRIS_CS            TRISBbits.TRISB15

#define TFT_RES            LATBbits.LATB12
#define TRIS_RES           TRISBbits.TRISB12

#define TFT_DC             LATBbits.LATB10
...
void TFT_TetLEFT(Schar *buffer, Uint y, Uint color1, Uint color2);
